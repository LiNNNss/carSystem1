...
public class CarController {
     ...
     * @return
     */
    @GetMapping("findByCarType")
    public List<Car> findByCarType(@RequestBody Map map ){
        String name = map.get("name").toString();
        int beginNum = Integer.parseInt(map.get("beginNum").toString());
        int endNum = Integer.parseInt(map.get("endNum").toString());
        name = "%" + name + "%";
        return carService.findByCarType(name, beginNum, endNum);
    }
}
